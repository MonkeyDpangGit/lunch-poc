...
//                + "?lt=LT-1052555-1Ih5FPlOpyf0lD2X2qmdTHeeylDsWC&validated=true&service=http%3A%2F%2Feiam.epri.sgcc.com.cn%3A8035%2Fauth%2Fud%2Fisc%2Flogin%2Fe3e3dcea-291f-4fb5-a390-dae6a4e171dd&execution=e2s1&encryptionKey=%40010001&encryptionType=rsa");
    ...
    public String serviceValidate(HttpServletRequest request, HttpServletResponse response) {
        ...
        String responseBody = "<cas:serviceResponse xmlns:cas='http://www.yale.edu/tp/cas'>\n"
                ...
                + "\t\t<cas:user>{\"passWord\":null,\"iscUserSourceId\":\"aaaaa\",\"logintime\":1634113231179,\"iscAdCode\":\"yanjue\",\"scop\":0,\"baseOrgId\":\"1\",\"name\":\"yanjue\",\"iscUserId\":\"aaaaa\"}</cas:user>\n"
                + "\t\t<cas:attributes>\n"
                + "\t\t\t<cas:iscUserId>aaaaa</cas:iscUserId>\n"
                + "\t\t</cas:attributes>\n"
                + "        </cas:authenticationSuccess>\n"
                + "</cas:serviceResponse>";
        return responseBody;
    ...
    public String verifyUserPassword(HttpServletRequest request, HttpServletResponse response) {
